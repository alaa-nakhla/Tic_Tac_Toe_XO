                ...
                onChanged: (value) {
                  ...
                  xoControler.orginalPatch!.value = List.generate(
                      ...
                      (i) => List.generate(
                          ...
                          (j) => xoControler
                              .mapPatches![xoControler.select.value]![i][j]).obs);
                }),
                          ...
                          return GestureDetector(
                            onTap: () {
                              ...
                              xoControler.checkWin()
                                  ...
                                  : xoControler.checkTie()?showDialog(
                                  barrierColor:
                                  Colors.grey.withOpacity(0.5),
                                  barrierDismissible: false,
                                  context: context,
                            ...
                            child:Obx(() =>AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: xoControler.mapPatches![xoControler.select]![x][y]),
                              child: Center(
                                child: xoControler.mapPatches![xoControler.select.value]![x][y] ==
                                        Colors.red
                                    ? Text("o",
                                        style: TextStyle(
                                            color: Colors.black,
                                            ...
                                            fontWeight: FontWeight.bold))
                                    : xoControler.mapPatches![xoControler.select.value]
                                                ![x][y] ==
                                            Colors.blue
                                        ? Text("x",
                                            style: TextStyle(
